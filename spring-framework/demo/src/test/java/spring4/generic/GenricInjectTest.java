...
public class GenricInjectTest {
    ...
    public void testGenericAPI() {
        ...
        System.out.println(genericType.getTypeName());//spring4.generic.B
        System.out.println(genericType.getClass());//class java.lang.Class
        ...
        //以下是得到接口上的
        System.out.println(resolvableType1.getInterfaces()[0].getGeneric(1).resolve());//class spring4.generic.B
        //转换为某个类型（父类/实现的接口）  还提供了简便方法 asMap() /asCollection
        System.out.println(resolvableType1.as(Service.class).getGeneric(1).resolve());//class spring4.generic.B
